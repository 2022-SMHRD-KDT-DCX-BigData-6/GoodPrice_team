                  ...
                  <!-- Me -->
                     <article id="home" class="panel intro">
                        ...
                        <table>                        
                              ...
                              <tr>
                                <td><a href="myPagePtMinus.do?m_point2000=2000&m_id=<%=m_id%>">2000point</a></td>
                                <td></td>
                                <td><a href="myPagePtMinus.do?m_point4000=4000&m_id=<%=m_id%>">4000point</a></td>
                              </tr>
                              <tr> 
                              ...
                              <tr> 
                                <td><a href="myPagePtMinus.do?m_point6000=6000&m_id=<%=m_id%>">6000point</a></td>
                                <td></td>
                                <td><a href="myPagePtMinus.do?m_point8000=8000&m_id=<%=m_id%>">8000point</a></td>
                              </tr>
                           </table>
